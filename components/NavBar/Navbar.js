...
const Navbar = () => {
    ...
    return (
      <div
        className={`w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4 relative`}
      >
        <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
          ...
          <div className="hidden lgl:inline-flex items-center gap-5">
            <ul className="flex text[13px] gap-5">
              ...
              <Navitem name={"Experience"} delay={".25"} />
              <Navitem name={"Projects"} delay={".3"} />
              <Navitem name={"Contact"} delay={".35"} />
            </ul>
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col items-center gap-7">
                  ...
                  {/* Mobile Social Links - Only GitHub, LinkedIn, LeetCode */}
